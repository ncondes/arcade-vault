/**
 * Ocho siluetas pixeladas de formas arcade clásicas que flotan tras el hero.
 * Son puro adorno: el contenedor va `aria-hidden` y no recibe eventos
 * (`pointer-events: none` en `.home-silos`).
 *
 * Los colores van escritos a mano en cada `<g>` porque el CSS de `.silo` usa
 * `currentColor` solo para el `drop-shadow`, no para el relleno.
 */
