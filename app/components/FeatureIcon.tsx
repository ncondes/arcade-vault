 ...
 * `.feature-card.cyan|yellow|magenta|green` pone en el padre.
 *
 * El `switch` es exhaustivo sobre `FeatureIconKind`: si mañana se añade un
 * quinto icono, TypeScript obliga a dibujarlo aquí en vez de devolver `null`.
 */
